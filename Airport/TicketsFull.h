#ifndef TICKETSFULL_H
#define TICKETSFULL_H
	...
	{
		public:
                        explicit TicketsFull(unsigned int&, unsigned int&, QString&, QString&, QString&, unsigned short&, unsigned int&, QString&, QString&, QString&, QString&, QString&, QString&, unsigned int&, unsigned int&, unsigned int&, unsigned int&, bool&, QString&, QString&, unsigned int&, unsigned int&, unsigned int&, bool&);
                        explicit TicketsFull(unsigned int, unsigned int, QString, QString, QString, unsigned short, unsigned int, QString, QString, QString, QString, QString, QString, unsigned int, unsigned int, unsigned int, unsigned int, bool, QString, QString, unsigned int, unsigned int, unsigned int, bool);
                        explicit TicketsFull(unsigned int&, unsigned int&, QString&, QString&, QString&, unsigned short&, unsigned int&, QDateTime&, QDateTime&, QString&, QString&, QString&, QString&, unsigned int&, unsigned int&, unsigned int&, unsigned int&, bool&, QString&, QString&, unsigned int&, unsigned int&, unsigned int&, bool&);
                        explicit TicketsFull(unsigned int, unsigned int, QString, QString, QString, unsigned short, unsigned int, QDateTime, QDateTime, QString, QString, QString, QString, unsigned int, unsigned int, unsigned int, unsigned int, bool, QString, QString, unsigned int, unsigned int, unsigned int, bool);
						TicketsFull(void);
